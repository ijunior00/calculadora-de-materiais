...
static/test.js      suíte de 248 testes (runBOMTests)
...
```bash
npm test              # 248 testes de BOM em Node, sem navegador (~1s)
...
|---|---|---|
| `/m?debug=1` (mobile) | **248** | carrega `scarf.js`; cobre o escalonamento |
| `/?debug=1` (desktop) | **246** | não carrega `scarf.js`; aqueles 2 testes se auto-pulam |
| `npm test` (Node) | **248** | carrega `scarf.js` com stubs de DOM |
