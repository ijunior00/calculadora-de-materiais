...
static/test.js      suíte de 218 testes (runBOMTests)
...
```bash
npm test              # 218 testes de BOM em Node, sem navegador (~1s)
...
|---|---|---|
| `/m?debug=1` (mobile) | **218** | carrega `scarf.js`; cobre o escalonamento |
| `/?debug=1` (desktop) | **216** | não carrega `scarf.js`; aqueles 2 testes se auto-pulam |
| `npm test` (Node) | **218** | carrega `scarf.js` com stubs de DOM |
